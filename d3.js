	...
	! function(t, n) {
		...
		function zt(t, n) {
			...
			function h(h) {
				...
				}))), M.remove(), x.attr("d", t === At || t === Mt ? a ? "M" + f * a + "," + v + "H" + c + "V" + _ + "H" + f * a : "M" + c + "," + v + "V" + _ : a ? "M" + v + "," + f * a + "V" + c + "H" + _ + "V" + f * a : "M" + v + "," + c + "H" + _), w.attr("opacity", 1).attr("transform", (function(t) {
					return l(b(t) + c)
				})), A.attr(s + "2", f * o), S.attr(s, f * g).text(p), m.filter(Pt).attr("fill", "none").attr("font-size", 10).attr("font-family", "sans-serif").attr("text-anchor", t === Mt ? "start" : t === At ? "end" : "middle"), m.each((function() {
					this.__axis = b
				}))
			}
		...
		Rt.prototype = Dt.prototype = {
			...
			on: function(t, n) {
				...
				if (!(arguments.length < 2)) {
					...
					for (; ++a < u;)
						if (e = (t = o[a]).type) i[e] = qt(i[e], t.name, n);
						else if (null == n)
						for (e in i) i[e] = qt(i[e], t.name, null);
					return this
				}
				for (; ++a < u;)
					if ((e = (t = o[a]).type) && (e = Ft(i[e], t.name))) return e
			},
			copy: function() {
				var t = {},
					n = this._;
		...
		function Ot(t) {
			var n = t += "",
				e = n.indexOf(":");
			return e >= 0 && "xmlns" !== (n = t.slice(0, e)) && (t = t.slice(e + 1)), It.hasOwnProperty(n) ? {
				space: It[n],
				local: t
			} : t
		}
		...
		function rn(t, n, e, r, i, o) {
			for (var a, u = 0, c = n.length, f = o.length; u < f; ++u)(a = n[u]) ? (a.__data__ = o[u], r[u] = a) : e[u] = new en(t, o[u]);
		...
		function on(t, n, e, r, i, o, a) {
			...
			for (u = 0; u < h; ++u) f = a.call(t, o[u], u, o) + "", (c = s.get(f)) ? (r[u] = c, c.__data__ = o[u], s.delete(f)) : e[u] = new en(t, o[u]);
		...
		Wn.prototype = Zn.prototype = {
			...
			on: function(t, n, e) {
				var r, i, o = function(t) {
					...
					a = o.length;
				if (!(arguments.length < 2)) {
					for (u = n ? jn : Ln, r = 0; r < a; ++r) this.each(u(o[r], n, e));
					return this
				}
		...
		function ee(t, n) {
			if (t = ne(t), void 0 === n && (n = t.currentTarget), n) {
		...
		function ue(t) {
			...
			"onselectstart" in n ? e.on("selectstart.drag", ae, ie) : (n.__noselect = n.style.MozUserSelect, n.style.MozUserSelect = "none")
		}

		function ce(t, n) {
			var e = t.document.documentElement,
				r = Kn(t).on("dragstart.drag", null);
			n && (r.on("click.drag", ae, ie), setTimeout((function() {
		...
		function Re(t, n, e, r) {
			return r <= 0 && (t = n = e = NaN), new Ue(t, n, e, r)
		}

		function Fe(t) {
			return t instanceof ve || (t = $e(t)), t ? new Ue((t = t.rgb()).r, t.g, t.b, t.opacity) : new Ue
		}
		...
		function He(t) {
			...
			if (t instanceof ve || (t = $e(t)), !t) return new Ge;
			...
			var n = (t = t.rgb()).r / 255,
				...
				u = o - i,
				c = (o + i) / 2;
			return u ? (a = n === o ? (e - r) / u + 6 * (e < r) : e === o ? (r - n) / u + 2 : (n - e) / u + 4, u /= c < .5 ? o + i : 2 - o - i, a *= 60) : u = c > 0 && c < 1 ? 0 : a, new Ge(a, u, c, t.opacity)
		}
		...
		ge(ve, $e, {
			...
			brighter(t) {
				return t = null == t ? be : Math.pow(be, t), new Ue(this.r * t, this.g * t, this.b * t, this.opacity)
			},
			darker(t) {
				return t = null == t ? _e : Math.pow(_e, t), new Ue(this.r * t, this.g * t, this.b * t, this.opacity)
			},
			rgb() {
				return this
			},
			...
			brighter(t) {
				return t = null == t ? be : Math.pow(be, t), new Ge(this.h, this.s, this.l * t, this.opacity)
			},
			darker(t) {
				return t = null == t ? _e : Math.pow(_e, t), new Ge(this.h, this.s, this.l * t, this.opacity)
			},
			rgb() {
		...
		function ar(t) {
			if (t instanceof cr) return new cr(t.l, t.a, t.b, t.opacity);
			if (t instanceof gr) return yr(t);
			t instanceof Ue || (t = Fe(t));
			var n, e, r = hr(t.r),
				i = hr(t.g),
				o = hr(t.b),
				a = fr((.2225045 * r + .7168786 * i + .0606169 * o) / tr);
			return r === i && i === o ? n = e = a : (n = fr((.4360747 * r + .3850649 * i + .1430804 * o) / Je), e = fr((.0139322 * r + .0971045 * i + .7141733 * o) / nr)), new cr(116 * a - 16, 500 * (n - a), 200 * (a - e), t.opacity)
		}
		...
		function dr(t) {
			if (t instanceof gr) return new gr(t.h, t.c, t.l, t.opacity);
			if (t instanceof cr || (t = ar(t)), 0 === t.a && 0 === t.b) return new gr(NaN, 0 < t.l && t.l < 100 ? 0 : NaN, t.l, t.opacity);
		...
		function yr(t) {
			if (isNaN(t.h)) return new cr(t.l, 0, 0, t.opacity);
			var n = t.h * Ke;
		...
		ge(Sr, Ar, ye(ve, {
			brighter(t) {
				return t = null == t ? be : Math.pow(be, t), new Sr(this.h, this.s, this.l * t, this.opacity)
			},
			darker(t) {
				return t = null == t ? _e : Math.pow(_e, t), new Sr(this.h, this.s, this.l * t, this.opacity)
			},
			rgb() {
		...
		function Gr(t, n) {
			var e, r, i, o = Hr.lastIndex = Xr.lastIndex = 0,
				a = -1,
				u = [],
				c = [];
			for (t += "", n += "";
				(e = Hr.exec(t)) && (r = Xr.exec(n));)(i = r.index) > o && (i = n.slice(o, i), u[a] ? u[a] += i : u[++a] = i), (e = e[0]) === (r = r[0]) ? u[a] ? u[a] += r : u[++a] = r : (u[++a] = null, c.push({
				i: a,
				x: Lr(e, r)
			})), o = Xr.lastIndex;
		...
		function Vr(t, n) {
			var e, r = typeof n;
			return null == n || "boolean" === r ? Cr(n) : ("number" === r ? Lr : "string" === r ? (e = $e(n)) ? (n = e, Rr) : Gr : n instanceof $e ? Rr : n instanceof Date ? Yr : Or(n) ? Ir : Array.isArray(n) ? Br : "function" != typeof n.valueOf && "function" != typeof n.toString || isNaN(n) ? jr : Lr)(t, n)
		}
		...
		var ni = ti((function(t) {
			...
			ei = ti((function(t) {
				return null == t ? Qr : (Zr || (Zr = document.createElementNS("http://www.w3.org/2000/svg", "g")), Zr.setAttribute("transform", t), (t = Zr.transform.baseVal.consolidate()) ? Jr((t = t.matrix).a, t.b, t.c, t.d, t.e, t.f) : Qr)
			}), ", ", ")", ")");
		...
		var gi, yi, vi = 0,
			...
			wi = 0,
			Mi = 0,
			Ti = "object" == typeof performance && performance.now ? performance : Date,
			Ai = "object" == typeof window && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(t) {
				setTimeout(t, 17)
			};

		function Si() {
			return wi || (Ai(Ei), wi = Ti.now() + Mi)
		}
		...
		function Ci() {
			Si(), ++vi;
			for (var t, n = gi; n;)(t = wi - n._time) >= 0 && n._call.call(void 0, t), n = n._next;
			--vi
		}

		function Pi() {
			wi = (xi = Ti.now()) + Mi, vi = _i = 0;
			try {
				Ci()
			} finally {
				vi = 0,
					function() {
						var t, n, e = gi,
							r = 1 / 0;
						for (; e;) e._call ? (r > e._time && (r = e._time), t = e, e = e._next) : (n = e._next, e._next = null, e = t ? t._next = n : gi = n);
						yi = t, $i(r)
					}(), wi = 0
			}
		}
		...
		function $i(t) {
			vi || (_i && (_i = clearTimeout(_i)), t - wi > 24 ? (t < 1 / 0 && (_i = setTimeout(Pi, t - Ti.now() - Mi)), bi && (bi = clearInterval(bi))) : (bi || (xi = Ti.now(), bi = setInterval(zi, mi)), vi = 1, Ai(Pi)))
		}
		...
		Ni.prototype = ki.prototype = {
			...
			restart: function(t, n, e) {
				...
				e = (null == e ? Si() : +e) + (null == n ? 0 : +n), this._next || yi === this || (yi ? yi._next = this : gi = this, yi = this), this._call = t, this._time = e, $i()
			},
			stop: function() {
		...
		function ji(t, n, e, r, i, o) {
			...
			! function(t, n, e) {
				...
				function o(t) {
					e.state = Ui, e.timer.restart(a, e.delay, e.time), e.delay <= t && a(t - e.delay)
				}

				function a(o) {
					var f, s, l, h;
					if (e.state !== Ui) return c();
					for (f in i)
						if ((h = i[f]).name === e.name) {
							if (h.state === Oi) return Di(a);
							h.state === Bi ? (h.state = Li, h.timer.stop(), h.on.call("interrupt", t, t.__data__, h.index, h.group), delete i[f]) : +f < n && (h.state = Li, h.timer.stop(), h.on.call("cancel", t, t.__data__, h.index, h.group), delete i[f])
						}
					if (Di((function() {
							e.state === Oi && (e.state = Bi, e.timer.restart(u, e.delay, e.time), u(o))
						})), e.state = Ii, e.on.call("start", t, t.__data__, e.index, e.group), e.state === Ii) {
						for (e.state = Oi, r = new Array(l = e.tween.length), f = 0, s = -1; f < l; ++f)(h = e.tween[f].value.call(t, t.__data__, e.index, e.group)) && (r[++s] = h);
						r.length = s + 1
					}
				}

				function u(n) {
					for (var i = n < e.duration ? e.ease.call(null, n / e.duration) : (e.timer.restart(c), e.state = Yi, 1), o = -1, a = r.length; ++o < a;) r[o].call(t, i);
					e.state === Yi && (e.on.call("end", t, t.__data__, e.index, e.group), c())
				}

				function c() {
					for (var r in e.state = Li, e.timer.stop(), delete i[n], i) return;
					delete t.__transition
				}
				i[n] = e, e.timer = ki(o, 0, e.time)
			}(t, e, {
				name: n,
				index: r,
				group: i,
		...
		function Xi(t, n) {
			var e = Gi(t, n);
			if (e.state > Oi) throw new Error("too late; already running");
			return e
		}
		...
		function Vi(t, n) {
			var e, r, i, o = t.__transition,
				a = !0;
			if (o) {
				for (i in n = null == n ? null : n + "", o)(e = o[i]).name === n ? (r = e.state > Ii && e.state < Yi, e.state = Li, e.timer.stop(), e.on.call(r ? "interrupt" : "cancel", t, t.__data__, e.index, e.group), delete o[i]) : a = !1;
		...
		function Qi(t, n) {
			var e;
			return ("number" == typeof n ? Lr : n instanceof $e ? Rr : (e = $e(n)) ? (n = e, Rr) : Gr)(t, n)
		}
		...
		go.prototype = yo.prototype = {
			...
			select: function(t) {
				...
				for (var r = this._groups, i = r.length, o = new Array(i), a = 0; a < i; ++a)
					for (var u, c, f = r[a], s = f.length, l = o[a] = new Array(s), h = 0; h < s; ++h)(u = f[h]) && (c = t.call(u, u.__data__, h, f)) && ("__data__" in u && (c.__data__ = u.__data__), l[h] = c, ji(l[h], n, e, h, l, Gi(u, e)));
			...
			selectAll: function(t) {
				...
				for (var r = this._groups, i = r.length, o = [], a = [], u = 0; u < i; ++u)
					for (var c, f = r[u], s = f.length, l = 0; l < s; ++l)
						if (c = f[l]) {
							for (var h, d = t.call(c, c.__data__, l, f), p = Gi(c, e), g = 0, y = d.length; g < y; ++g)(h = d[g]) && ji(h, n, e, g, d, p);
							o.push(d), a.push(c)
						}
			...
			style: function(t, n, e) {
				...
				return null == n ? this.styleTween(t, function(t, n) {
					...
					return function() {
						var o = bn(this, t),
							a = (this.style.removeProperty(t), bn(this, t));
					...
					return function() {
						var a = bn(this, t),
							u = e(this),
							c = u + "";
						return null == u && (this.style.removeProperty(t), c = u = bn(this, t)), a === c ? null : a === r && c === i ? o : (i = c, o = n(r = a, u))
					}
		...
		Zn.prototype.interrupt = function(t) {
			...
			var n, e;
			t instanceof go ? (n = t._id, t = t._name) : (n = vo(), (e = Wo).time = Si(), t = null == t ? null : t + "");
			for (var r = this._groups, i = r.length, o = 0; o < i; ++o)
				for (var a, u = r[o], c = u.length, f = 0; f < c; ++f)(a = u[f]) && ji(a, t, n, f, u, e || Zo(a, n));
		...
		function Ma(t) {
			...
			function h(e) {
				if ((!n || e.touches) && r.apply(this, arguments)) {
					var i, a, u, c, l, h, d, p, g, y, v, _ = this,
						...
						m = "selection" === (o && e.metaKey ? b = "overlay" : b) ? na : o && e.altKey ? ia : ra,
						x = t === la ? null : ya[b],
						w = t === sa ? null : va[b],
						M = wa(_),
						T = M.extent,
						...
						$ = Array.from(e.touches || [e], (t => {
							...
							return (t = ee(t, _)).point0 = t.slice(), t.identifier = n, t
						}));
					Vi(_);
					...
					if ("overlay" === b) {
						...
						const n = [$[0], $[1] || $[0]];
						M.selection = A = [
							[i = t === la ? S : ua(n[0][0], n[1][0]), u = t === sa ? E : ua(n[0][1], n[1][1])],
							[l = t === la ? N : aa(n[0][0], n[1][0]), d = t === sa ? k : aa(n[0][1], n[1][1])]
						], $.length > 1 && I(e)
						...
						o && q.on("keydown.brush", (function(t) {
							switch (t.keyCode) {
								case 16:
									...
									break;
								case 18:
									m === ra && (x && (l = h - C * x, i = a + C * x), w && (d = p - P * w, u = c + P * w), m = ia, I(t));
									break;
								case 32:
									m !== ra && m !== ia || (x < 0 ? l = h - C : x > 0 && (i = a - C), w < 0 ? d = p - P : w > 0 && (u = c - P), m = ea, F.attr("cursor", da.selection), I(t));
									break;
								default:
									return
							}
							...
							switch (t.keyCode) {
								case 16:
									...
									break;
								case 18:
									m === ia && (x < 0 ? l = h : x > 0 && (i = a), w < 0 ? d = p : w > 0 && (u = c), m = ra, I(t));
									break;
								case 32:
									m === ea && (t.altKey ? (x && (l = h - C * x, i = a + C * x), w && (d = p - P * w, u = c + P * w), m = ia) : (x < 0 ? l = h : x > 0 && (i = a), w < 0 ? d = p : w > 0 && (u = c), m = ra), F.attr("cursor", da[b]), I(t));
									break;
								default:
									return
							}
				...
				function U(t) {
					for (const n of t.changedTouches || [t])
						for (const t of $) t.identifier === n.identifier && (t.cur = ee(n, _));
					if (z && !y && !v && 1 === $.length) {
						const t = $[0];
				...
				function I(t) {
					...
					switch (C = n[0] - e[0], P = n[1] - e[1], m) {
						case ea:
						case na:
							x && (C = aa(S - i, ua(N - l, C)), a = i + C, h = l + C), w && (P = aa(E - u, ua(k - d, P)), c = u + P, p = d + P);
							break;
						case ra:
							$[1] ? (x && (a = aa(S, ua(N, $[0][0])), h = aa(S, ua(N, $[1][0])), x = 1), w && (c = aa(E, ua(k, $[0][1])), p = aa(E, ua(k, $[1][1])), w = 1)) : (x < 0 ? (C = aa(S - i, ua(N - i, C)), a = i + C, h = l) : x > 0 && (C = aa(S - l, ua(N - l, C)), a = i, h = l + C), w < 0 ? (P = aa(E - u, ua(k - u, P)), c = u + P, p = d) : w > 0 && (P = aa(E - d, ua(k - d, P)), c = u, p = d + P));
							break;
						case ia:
							x && (a = aa(S, ua(N, i - C * x)), h = aa(S, ua(N, l + C * x))), w && (c = aa(E, ua(k, u - P * w)), p = aa(E, ua(k, d + P * w)))
					}
					h < a && (x *= -1, r = i, i = l, l = r, r = a, a = h, h = r, b in pa && F.attr("cursor", da[b = pa[b]])), p < c && (w *= -1, r = u, u = d, d = r, r = c, c = p, p = r, b in ga && F.attr("cursor", da[b = ga[b]])), M.selection && (A = M.selection), y && (a = A[0][0], h = A[1][0]), v && (c = A[0][1], p = A[1][1]), A[0][0] === a && A[0][1] === c && A[1][0] === h && A[1][1] === p || (M.selection = [
						[a, c],
						[h, p]
				...
				function O(t) {
					...
					} else ce(t.view, g), q.on("keydown.brush keyup.brush mousemove.brush mouseup.brush", null);
					R.attr("pointer-events", "all"), F.attr("cursor", da.overlay), M.selection && (A = M.selection),
						function(t) {
			...
			function g() {
				...
				return n.extent = fa(e.apply(this, arguments)), n.dim = t, n
			}
			return c.move = function(n, e, r) {
				n.tween ? n.on("start.brush", (function(t) {
					...
					var n = this,
						...
						u = s(n, i).beforestart();
					Vi(n), o.selection = null === a ? null : a, f.call(n), u.start(r).brush(r).end(r)
				}))
				...
				return arguments.length ? (e = "function" == typeof t ? t : Qo(fa(t)), c) : e
			}, c.filter = function(t) {
				return arguments.length ? (r = "function" == typeof t ? t : Qo(!!t), c) : r
			}, c.touchable = function(t) {
				return arguments.length ? (i = "function" == typeof t ? t : Qo(!!t), c) : i
		...
		function $a(t, n) {
			...
			return a.padAngle = function(t) {
				return arguments.length ? (e = Ca(0, t), a) : e
		...
		let Ia = class {
			constructor(t) {
				this._x0 = this._y0 = this._x1 = this._y1 = null, this._ = "", this._append = null == t ? Ua : function(t) {
					let n = Math.floor(t);
				...
				if (null === this._x1) this._append `M${this._x1=t},${this._y1=n}`;
					...
					if (Math.abs(s * u - c * f) > Fa && i) {
						let h = e - o,
							...
							b = _ / v,
							m = _ / y;
						Math.abs(b - 1) > Fa && this._append `L${t+b*f},${n+b*s}`, this._append `A${i},${i},0,0,${+(s*h>f*d)},${this._x1=t+m*u},${this._y1=n+m*c}`
			...
			arc(t, n, e, r, i, o) {
				...
				let a = e * Math.cos(r),
					...
					s = 1 ^ o,
					l = o ? r - i : i - r;
				null === this._x1 ? this._append `M${c},${f}` : (Math.abs(this._x1 - c) > Fa || Math.abs(this._y1 - f) > Fa) && this._append `L${c},${f}`, e && (l < 0 && (l = l % Ra + Ra), l > qa ? this._append `A${e},${e},0,1,${s},${t-a},${n-u}A${e},${e},0,1,${s},${this._x1=c},${this._y1=f}` : l > Fa && this._append `A${e},${e},0,${+(l>=Da)},${s},${this._x1=t+e*Math.cos(i)},${this._y1=n+e*Math.sin(i)}`)
			}
			rect(t, n, e, r) {
		...
		function Za(t) {
			...
			function f() {
				var f, s = n.apply(this, arguments),
					...
					_ = o.apply(this, d) - Na,
					b = a.apply(this, d) - Na;
				if (c || (c = f = Oa()), h > Pa && (Ta(y - g) > 2 * h + Pa ? y > g ? (g += h, y -= h) : (g -= h, y += h) : g = y = (g + y) / 2, Ta(b - _) > 2 * h + Pa ? b > _ ? (_ += h, b -= h) : (_ -= h, b += h) : _ = b = (_ + b) / 2), c.moveTo(p * Aa(g), p * Sa(g)), c.arc(0, 0, p, g, y), g !== _ || y !== b)
					if (t) {
						var m = v - +t.apply(this, arguments),
							x = (_ + b) / 2;
						c.quadraticCurveTo(0, 0, m * Aa(_), m * Sa(_)), c.lineTo(v * Aa(x), v * Sa(x)), c.lineTo(m * Aa(b), m * Sa(b))
					} else c.quadraticCurveTo(0, 0, v * Aa(_), v * Sa(_)), c.arc(0, 0, v, _, b);
				if (c.quadraticCurveTo(0, 0, p * Aa(g), p * Sa(g)), c.closePath(), f) return c = null, f + "" || null
			}
		...
		function ou() {
			...
			function i(t) {
				var n = e(t);
				if (Array.isArray(n)) n = n.slice().sort(Qa);
				else {
					const e = T(t, au);
			...
			function o(e, i) {
				...
				return function(e, r, i) {
					var o, u, c, f, s, l, h = new Array,
						d = new Array;
					o = u = -1, f = uu(e[0], r), iu[f << 1].forEach(p);
					for (; ++o < t - 1;) c = f, f = uu(e[o + 1], r), iu[c | f << 1].forEach(p);
					iu[f << 0].forEach(p);
					for (; ++u < n - 1;) {
						for (o = -1, f = uu(e[u * t + t], r), s = uu(e[u * t], r), iu[f << 1 | s << 2].forEach(p); ++o < t - 1;) c = f, f = uu(e[u * t + t + o + 1], r), l = s, s = uu(e[u * t + o + 1], r), iu[c | f << 1 | s << 2 | l << 3].forEach(p);
						iu[f | s << 3].forEach(p)
					}
					o = -1, s = e[u * t] >= r, iu[s << 2].forEach(p);
					for (; ++o < t - 1;) l = s, s = uu(e[u * t + o + 1], r), iu[s << 2 | l << 3].forEach(p);
					...
					for (var n, e = 0, r = u.length; e < r; ++e)
						if (-1 !== tu((n = u[e])[0], t)) return void n.push(t)
				})), {
					type: "MultiPolygon",
					value: i,
					coordinates: u
			...
			function u(e, r, i) {
				e.forEach((function(e) {
					var o = e[0],
						...
						c = 0 | a,
						f = cu(r[c * t + u]);
					o > 0 && o < t && u === o && (e[0] = fu(o, cu(r[c * t + u - 1]), f, i)), a > 0 && a < n && c === a && (e[1] = fu(a, cu(r[(c - 1) * t + u]), f, i))
				}))
			}
			return i.contour = o, i.size = function(e) {
				...
				return arguments.length ? (e = "function" == typeof t ? t : Array.isArray(t) ? Ja(Ka.call(t)) : Ja(t), i) : e
			}, i.smooth = function(t) {
				return arguments.length ? (r = t ? u : ru, i) : r === u
			}, i
		}
		...
		function Tu(t, n, e, r, i, o) {
			...
			return Math.abs(c) >= 33306690738754716e-32 * f ? c : - function(t, n, e, r, i, o, a) {
				...
				const A = t - i,
					...
					E = n - o,
					N = r - o;
				m = A * N, h = du * A, d = h - (h - A), p = A - d, h = du * N, g = h - (h - N), y = N - g, x = p * y - (m - d * g - p * g - d * y), w = E * S, h = du * E, d = h - (h - E), p = E - d, h = du * S, g = h - (h - S), y = S - g, M = p * y - (w - d * g - p * g - d * y), v = x - M, l = x - v, bu[0] = x - (v + l) + (l - M), _ = m + v, l = _ - m, b = m - (_ - l) + (v - l), v = b - w, l = b - v, bu[1] = b - (v + l) + (l - w), T = _ + v, l = T - _, bu[2] = _ - (T - l) + (v - l), bu[3] = T;
				let k = function(t, n) {
						let e = n[0];
				...
				if (C = _u * a + pu * Math.abs(k), k += A * s + N * u - (E * f + S * c), k >= C || -k >= C) return k;
				m = u * N, h = du * u, d = h - (h - u), p = u - d, h = du * N, g = h - (h - N), y = N - g, x = p * y - (m - d * g - p * g - d * y), w = c * S, h = du * c, d = h - (h - c), p = c - d, h = du * S, g = h - (h - S), y = S - g, M = p * y - (w - d * g - p * g - d * y), v = x - M, l = x - v, Mu[0] = x - (v + l) + (l - M), _ = m + v, l = _ - m, b = m - (_ - l) + (v - l), v = b - w, l = b - v, Mu[1] = b - (v + l) + (l - w), T = _ + v, l = T - _, Mu[2] = _ - (T - l) + (v - l), Mu[3] = T;
				const P = gu(4, bu, 4, Mu, mu);
				m = A * s, h = du * A, d = h - (h - A), p = A - d, h = du * s, g = h - (h - s), y = s - g, x = p * y - (m - d * g - p * g - d * y), w = E * f, h = du * E, d = h - (h - E), p = E - d, h = du * f, g = h - (h - f), y = f - g, M = p * y - (w - d * g - p * g - d * y), v = x - M, l = x - v, Mu[0] = x - (v + l) + (l - M), _ = m + v, l = _ - m, b = m - (_ - l) + (v - l), v = b - w, l = b - v, Mu[1] = b - (v + l) + (l - w), T = _ + v, l = T - _, Mu[2] = _ - (T - l) + (v - l), Mu[3] = T;
				const z = gu(P, mu, 4, Mu, xu);
				m = u * s, h = du * u, d = h - (h - u), p = u - d, h = du * s, g = h - (h - s), y = s - g, x = p * y - (m - d * g - p * g - d * y), w = c * f, h = du * c, d = h - (h - c), p = c - d, h = du * f, g = h - (h - f), y = f - g, M = p * y - (w - d * g - p * g - d * y), v = x - M, l = x - v, Mu[0] = x - (v + l) + (l - M), _ = m + v, l = _ - m, b = m - (_ - l) + (v - l), v = b - w, l = b - v, Mu[1] = b - (v + l) + (l - w), T = _ + v, l = T - _, Mu[2] = _ - (T - l) + (v - l), Mu[3] = T;
		...
		class Eu {
			...
			update() {
				...
				for (let n = 0; n < o; n++) this._dists[n] = Nu(t[2 * n], t[2 * n + 1], M.x, M.y);
				Pu(this._ids, this._dists, 0, o - 1), this._hullStart = h;
				let T = 3;
				...
				for (let o, a, u = 0; u < this._ids.length; u++) {
					...
					let _ = e[y];
					for (; g = e[_], Tu(f, s, t[2 * _], t[2 * _ + 1], t[2 * g], t[2 * g + 1]) < 0;) v = this._addTriangle(_, c, g, r[c], -1, r[_]), r[c] = this._legalize(v + 2), e[_] = _, T--, _ = g;
					if (y === l)
						for (; g = n[y], Tu(f, s, t[2 * g], t[2 * g + 1], t[2 * y], t[2 * y + 1]) < 0;) v = this._addTriangle(g, c, y, -1, r[y], r[g]), this._legalize(v + 2), r[g] = v, e[y] = y, T--, y = g;
		...
		function Pu(t, n, e, r) {
			if (r - e <= 20)
				for (let i = e + 1; i <= r; i++) {
					...
					let i = e + 1,
						o = r;
					zu(t, e + r >> 1, i), n[t[e]] > n[t[r]] && zu(t, e, r), n[t[i]] > n[t[r]] && zu(t, i, r), n[t[e]] > n[t[i]] && zu(t, e, i);
					const a = t[i],
						u = n[a];
					for (;;) {
						do {
					...
					t[e + 1] = t[o], t[o] = a, r - i + 1 >= o - e ? (Pu(t, n, i, r), Pu(t, n, e, o - 1)) : (Pu(t, n, e, o - 1), Pu(t, n, i, r))
				}
		}
		...
		class Fu {
			...
			arc(t, n, e) {
				...
				null === this._x1 ? this._ += `M${r},${i}` : (Math.abs(this._x1 - r) > Ru || Math.abs(this._y1 - i) > Ru) && (this._ += "L" + r + "," + i), e && (this._ += `A${e},${e},0,1,1,${t-e},${n}A${e},${e},0,1,1,${this._x1=r},${this._y1=i}`)
			}
			rect(t, n, e, r) {
		...
		class ju {
			...
			constructor(t) {
				this._delaunator = new Eu(t), this.inedges = new Int32Array(t.length / 2), this._hullIndex = new Int32Array(t.length / 2), this.points = this._delaunator.coords, this._init()
			}
			update() {
			...
			_step(t, n, e) {
				...
				do {
					...
					if (h = a[h], -1 === h) {
						if (h = i[(o[t] + 1) % i.length], h !== r && Ou(n - c[2 * h], 2) + Ou(e - c[2 * h + 1], 2) < s) return h;
						break
					}
				} while (h !== l);
				return f
			...
			renderPoints(t, n) {
				...
				for (let e = 0, i = r.length; e < i; e += 2) {
					const i = r[e],
						o = r[e + 1];
					t.moveTo(i + n, o), t.arc(i, o, n, 0, Iu)
				}
				return e && e.value()
			}
			renderHull(t) {
		...
		function tc(t) {
			...
			function r(t, n) {
				...
				function s() {
					...
					if (t.charCodeAt(i) === Gu) {
						...
						return (n = a) >= o ? c = !0 : (r = t.charCodeAt(a++)) === Vu ? f = !0 : r === Wu && (f = !0, t.charCodeAt(a) === Vu && ++a), t.slice(i + 1, n - 1).replace(/""/g, '"')
					}
					for (; a < o;) {
						if ((r = t.charCodeAt(n = a++)) === Vu) f = !0;
						else if (r === Wu) f = !0, t.charCodeAt(a) === Vu && ++a;
						else if (r !== e) continue;
						return t.slice(i, n)
					}
					return c = !0, t.slice(i, o)
				}
				for (t.charCodeAt(o - 1) === Vu && --o, t.charCodeAt(o - 1) === Wu && --o;
					(r = s()) !== Xu;) {
					for (var l = []; r !== Hu && r !== Xu;) l.push(r), r = s();
			...
			return {
				...
				parseRows: r,
				format: function(n, e) {
					return null == e && (e = Ku(n)), [e.map(a).join(t)].concat(i(n, e)).join("\n")
				},
				formatBody: function(t, n) {
					return null == n && (n = Ku(t)), i(t, n).join("\n")
				},
		...
		function wc(t) {
			return function(n, e, r) {
				return 2 === arguments.length && "function" == typeof e && (r = e, e = void 0), xc(n, e).then((function(n) {
					return t(n, r)
				}))
			}
		}
		...
		qc.copy = function() {
			var t, n, e = new Rc(this._x, this._y, this._x0, this._y0, this._x1, this._y1),
				r = this._root;
			if (!r) return e;
			if (!r.length) return e._root = Fc(r), e;
			for (t = [{
					source: r,
			...
			for (this.cover(c, f).cover(s, l), e = 0; e < o; ++e) Cc(this, a[e], u[e], t[e]);
			return this
			...
			var r, i, o, a, u, c, f, s = this._x0,
				...
				p = [],
				g = this._root;
			for (g && p.push(new Pc(g, s, l, h, d)), null == e ? e = 1 / 0 : (s = t - e, l = n - e, h = t + e, d = n + e, e *= e); c = p.pop();)
				if (!(!(g = c.node) || (i = c.x0) > h || (o = c.y0) > d || (a = c.x1) < s || (u = c.y1) < l))
					if (g.length) {
						var y = (i + a) / 2,
							v = (o + u) / 2;
						p.push(new Pc(g[3], y, v, a, u), new Pc(g[2], i, v, y, u), new Pc(g[1], y, o, a, v), new Pc(g[0], i, o, y, v)), (f = (n >= v) << 1 | t >= y) && (c = p[p.length - 1], p[p.length - 1] = p[p.length - 1 - f], p[p.length - 1 - f] = c)
					} else {
			...
			for (c && u.push(new Pc(c, this._x0, this._y0, this._x1, this._y1)); n = u.pop();)
				if (!t(c = n.node, r = n.x0, i = n.y0, o = n.x1, a = n.y1) && c.length) {
					var f = (r + o) / 2,
						s = (i + a) / 2;
					(e = c[3]) && u.push(new Pc(e, f, s, o, a)), (e = c[2]) && u.push(new Pc(e, r, s, f, a)), (e = c[1]) && u.push(new Pc(e, f, i, o, s)), (e = c[0]) && u.push(new Pc(e, r, i, f, s))
				}
			return this
			...
			for (this._root && e.push(new Pc(this._root, this._x0, this._y0, this._x1, this._y1)); n = e.pop();) {
				...
				if (i.length) {
					var o, a = n.x0,
						...
						s = (a + c) / 2,
						l = (u + f) / 2;
					(o = i[0]) && e.push(new Pc(o, a, u, s, l)), (o = i[1]) && e.push(new Pc(o, s, u, c, l)), (o = i[2]) && e.push(new Pc(o, a, l, s, f)), (o = i[3]) && e.push(new Pc(o, s, l, c, f))
				}
				r.push(n)
			}
		...
		function tf(t) {
			if (!(n = Jc.exec(t))) throw new Error("invalid format: " + t);
			var n;
			return new nf({
				fill: n[1],
				align: n[2],
		...
		tf.prototype = nf.prototype, nf.prototype.toString = function() {
		...
		var af, uf = Array.prototype.map,
			cf = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"];

		function ff(t) {
			var n, e, r = void 0 === t.grouping || void 0 === t.thousands ? of : (n = uf.call(t.grouping, Number), e = t.thousands + "", function(t, r) {
				...
				u = void 0 === t.numerals ? of : function(t) {
					return function(n) {
						return n.replace(/[0-9]/g, (function(n) {
							return t[+n]
						}))
					}
				}(uf.call(t.numerals, String)),
			...
			function l(t) {
				var n = (t = tf(t)).fill,
					...
					v = t.trim,
					_ = t.type;
				"n" === _ ? (g = !0, _ = "g") : rf[_] || (void 0 === y && (y = 12), v = !0, _ = "g"), (d || "0" === n && "=" === e) && (d = !0, n = "0", e = "=");
				...
				function M(t) {
					...
					if ("c" === _) M = x(t) + M, t = "";
						...
						if (t = isNaN(t) ? s : x(Math.abs(t), y), v && (t = function(t) {
							...
							}(t)), T && 0 == +t && "+" !== l && (T = !1), h = (T ? "(" === l ? l : f : "-" === l || "(" === l ? "" : l) + h, M = ("s" === _ ? cf[8 + Qc / 3] : "") + M + (T && "(" === l ? ")" : ""), w)
		...
		function sf(n) {
			return af = ff(n), t.format = af.format, t.formatPrefix = af.formatPrefix, af
		}
		...
		function df(t, n) {
			return t = Math.abs(t), n = Math.abs(n) - t, Math.max(0, Kc(n) - Kc(t)) + 1
		}
		t.format = void 0, t.formatPrefix = void 0, sf({
			thousands: ",",
			grouping: [3],
			currency: ["$", ""]
		});
		...
		var Of = {
				...
				FeatureCollection: function(t, n) {
					for (var e = t.features, r = -1, i = e.length; ++r < i;) If(e[r].geometry, n)
				}
			},
			Bf = {
				Sphere: function(t, n) {
				...
				MultiLineString: function(t, n) {
					for (var e = t.coordinates, r = -1, i = e.length; ++r < i;) Yf(e[r], n, 0)
				},
				Polygon: function(t, n) {
					Lf(t.coordinates, n)
				},
				MultiPolygon: function(t, n) {
					for (var e = t.coordinates, r = -1, i = e.length; ++r < i;) Lf(e[r], n)
				},
				GeometryCollection: function(t, n) {
					for (var e = t.geometries, r = -1, i = e.length; ++r < i;) If(e[r], n)
				}
			};
		...
		function Lf(t, n) {
			var e = -1,
				r = t.length;
			for (n.polygonStart(); ++e < r;) Yf(t[e], n, 1);
			n.polygonEnd()
		}
		...
		var Hf, Xf, Gf, Vf, Wf, Zf, Kf, Qf, Jf, ts, ns, es, rs, is, os, as, us = new A,
			cs = new A,
			fs = {
				point: Uf,
				lineStart: Uf,
				...
				polygonStart: function() {
					us = new A, fs.lineStart = ss, fs.lineEnd = ls
				},
				polygonEnd: function() {
					var t = +us;
					cs.add(t < 0 ? bf + t : t), this.lineStart = this.lineEnd = this.point = Uf
				},
				sphere: function() {
					cs.add(bf)
				}
		...
		function hs(t, n) {
			fs.point = ds, Hf = t, Xf = n, Gf = t *= xf, Vf = Af(n = (n *= xf) / 2 + _f), Wf = Pf(n)
		}
		...
		var xs, ws, Ms, Ts, As, Ss, Es, Ns, ks, Cs, Ps, zs, $s, Ds, Rs, Fs, qs = {
			...
			lineEnd: Bs,
			polygonStart: function() {
				qs.point = Ys, qs.lineStart = Ls, qs.lineEnd = js, is = new A, fs.polygonStart()
			},
			polygonEnd: function() {
				fs.polygonEnd(), qs.point = Us, qs.lineStart = Os, qs.lineEnd = Bs, us < 0 ? (Zf = -(Qf = 180), Kf = -(Jf = 90)) : is > pf ? Jf = 90 : is < -pf && (Kf = -90), as[0] = Zf, as[1] = Qf
			},
			sphere: function() {
				Zf = -(Qf = 180), Kf = -(Jf = 90)
			}
		...
		function Us(t, n) {
			os.push(as = [Zf = t, Qf = t]), n < Kf && (Kf = n), n > Jf && (Jf = n)
		}
		...
		function Is(t, n) {
			...
			if (rs) {
				...
				var o, a = t - ts,
					...
					c = i[0] * mf * u,
					f = wf(a) > 180;
				f ^ (u * ts < c && c < u * t) ? (o = i[1] * mf) > Jf && (Jf = o) : f ^ (u * ts < (c = (c + 360) % 360 - 180) && c < u * t) ? (o = -i[1] * mf) < Kf && (Kf = o) : (n < Kf && (Kf = n), n > Jf && (Jf = n)), f ? t < ts ? Hs(Zf, t) > Hs(Zf, Qf) && (Qf = t) : Hs(t, Qf) > Hs(Zf, Qf) && (Zf = t) : Qf >= Zf ? (t < Zf && (Zf = t), t > Qf && (Qf = t)) : t > ts ? Hs(Zf, t) > Hs(Zf, Qf) && (Qf = t) : Hs(t, Qf) > Hs(Zf, Qf) && (Zf = t)
			} else os.push(as = [Zf = t, Qf = t]);
			n < Kf && (Kf = n), n > Jf && (Jf = n), rs = e, ts = t
		}
		...
		function Bs() {
			as[0] = Zf, as[1] = Qf, qs.point = Us, rs = null
		}
		...
		function js() {
			Ys(ns, es), fs.lineEnd(), wf(is) > pf && (Zf = -(Qf = 180)), as[0] = Zf, as[1] = Qf, rs = null
		}
		...
		var Vs = {
			...
			lineEnd: tl,
			polygonStart: function() {
				Vs.lineStart = nl, Vs.lineEnd = el
			},
			polygonEnd: function() {
				Vs.lineStart = Ks, Vs.lineEnd = tl
			}
		};
		...
		function Zs(t, n, e) {
			++xs, Ms += (t - Ms) / xs, Ts += (n - Ts) / xs, As += (e - As) / xs
		}
		...
		function Qs(t, n) {
			t *= xf;
			var e = Af(n *= xf);
			Ds = e * Af(t), Rs = e * Pf(t), Fs = Pf(n), Vs.point = Js, Zs(Ds, Rs, Fs)
		}
		...
		function Js(t, n) {
			...
			ws += a, Ss += a * (Ds + (Ds = r)), Es += a * (Rs + (Rs = i)), Ns += a * (Fs + (Fs = o)), Zs(Ds, Rs, Fs)
		}
		...
		function rl(t, n) {
			zs = t, $s = n, t *= xf, n *= xf, Vs.point = il;
			var e = Af(n);
			Ds = e * Af(t), Rs = e * Pf(t), Fs = Pf(n), Zs(Ds, Rs, Fs)
		}
		...
		function il(t, n) {
			...
			var e = Af(n *= xf),
				...
				s = Ff(f),
				l = f && -s / f;
			ks.add(l * a), Cs.add(l * u), Ps.add(l * c), ws += s, Ss += s * (Ds + (Ds = r)), Es += s * (Rs + (Rs = i)), Ns += s * (Fs + (Fs = o)), Zs(Ds, Rs, Fs)
		}
		...
		function ul(t, n) {
			return wf(t) > yf && (t -= Math.round(t / bf) * bf), [t, n]
		}
		...
		function fl(t) {
			return function(n, e) {
				return wf(n += t) > yf && (n -= Math.round(n / bf) * bf), [n, e]
			}
		}

		function sl(t) {
			var n = fl(t);
			return n.invert = fl(-t), n
		}
		...
		function hl(t) {
			function n(n) {
				return (n = t(n[0] * xf, n[1] * xf))[0] *= mf, n[1] *= mf, n
			}
			return t = cl(t[0] * xf, t[1] * xf, t.length > 2 ? t[2] * xf : 0), n.invert = function(n) {
				return (n = t.invert(n[0] * xf, n[1] * xf))[0] *= mf, n[1] *= mf, n
			}, n
		}
		...
		function dl(t, n, e, r, i, o) {
			if (e) {
				var a = Af(n),
					u = Pf(n),
					c = r * e;
				null == i ? (i = n + r * bf, o = n - c / 2) : (i = pl(a, i), o = pl(a, o), (r > 0 ? i < o : i > o) && (i += r * bf));
				for (var f, s = i; r > 0 ? s > o : s < o; s -= c) f = ps([a, -u * Af(s), -u * Pf(s)]), t.point(f[0], f[1])
			}
		}
		...
		function _l(t, n, e, r, i) {
			...
			if (t.forEach((function(t) {
					if (!((n = t.length - 1) <= 0)) {
						...
						u.push(e = new vl(r, t, null, !0)), c.push(e.o = new vl(r, null, e, !1)), u.push(e = new vl(a, t, null, !1)), c.push(e.o = new vl(a, null, e, !0))
					}
				})), u.length) {
				for (c.sort(n), bl(u), bl(c), o = 0, a = c.length; o < a; ++o) c[o].e = e = !e;
				for (var f, s, l = u[0];;) {
					for (var h = l, d = !0; h.v;)
						if ((h = h.n) === l) return;
					f = h.z, i.lineStart();
		...
		function xl(t, n) {
			...
			for (var f = 0, s = t.length; f < s; ++f)
				if (h = (l = t[f]).length)
					for (var l, h, d = l[h - 1], p = ml(d), g = d[1] / 2 + _f, y = Pf(g), v = Af(g), _ = 0; _ < h; ++_, p = m, y = w, v = M, d = b) {
						var b = l[_],
							m = ml(b),
							x = b[1] / 2 + _f,
							w = Pf(x),
							...
							N = E > yf,
							k = y * w;
						if (c.add(Tf(k * S * Pf(E), v * M + k * Af(E))), a += N ? T + S * bf : T, N ^ p >= e ^ m >= e) {
							var C = vs(gs(d), gs(b));
							ms(C);
							var P = vs(o, C);
							ms(P);
			...
			return function(i) {
				var o, a, u, c = n(i),
					...
					h = {
						...
						polygonEnd: function() {
							...
							var t = xl(o, r);
							a.length ? (l || (i.polygonStart(), l = !0), _l(a, Tl, t, e, i)) : t && (l || (i.polygonStart(), l = !0), i.lineStart(), e(null, null, 1, i), i.lineEnd()), l && (i.polygonEnd(), l = !1), a = o = null
						},
						sphere: function() {
				...
				function b() {
					...
					if (u.pop(), o.push(u), u = null, d)
						...
						} else d > 1 && 2 & c && h.push(h.pop().concat(h.shift())), a.push(h.filter(Ml))
				}
				return h
			}
		}
		...
		var Al = wl((function() {
			...
			return {
				...
				point: function(o, a) {
					var u = o > 0 ? yf : -yf,
						c = wf(o - e);
					wf(c - yf) < pf ? (t.point(e, r = (r + a) / 2 > 0 ? vf : -vf), t.point(i, r), t.lineEnd(), t.lineStart(), t.point(u, r), t.point(o, r), n = 0) : i !== u && c >= yf && (wf(e - i) < pf && (e -= i * pf), wf(o - u) < pf && (o -= u * pf), r = function(t, n, e, r) {
						var i, o, a = Pf(t - e);
			...
			var i;
			if (null == t) i = e * vf, r.point(-yf, i), r.point(0, i), r.point(yf, i), r.point(yf, 0), r.point(yf, -i), r.point(0, -i), r.point(-yf, -i), r.point(-yf, 0), r.point(-yf, i);
		...
		function Sl(t) {
			...
			function a(t, e, r) {
				...
				if (!(y < 0)) {
					...
					var T = x - m,
						A = wf(T - yf) < pf;
					if (!A && M < w && (b = w, w = M, M = b), A || T < pf ? A ? w + M > 0 ^ _[1] < (wf(_[0] - m) < pf ? w : M) : w <= _[1] && _[1] <= M : T > yf ^ (m <= _[0] && _[0] <= x)) {
						var S = bs(d, (-p + v) / g);
						return _s(S, h), [_, ps(S)]
					}
				}
			}
			...
			return wl(o, (function(t) {
				...
				return {
					...
					point: function(l, h) {
						var d, p = [l, h],
							g = o(l, h),
							y = r ? g ? 0 : u(l, h) : g ? u(l + (l < 0 ? yf : -yf), h) : 0;
						if (!n && (f = c = g) && t.lineStart(), g !== c && (!(d = a(n, p)) || yl(n, d) || yl(p, d)) && (p[2] = 1), g !== c) s = 0, g ? (t.lineStart(), d = a(p, n), t.point(d[0], d[1])) : (d = a(n, p), t.point(d[0], d[1], 2), t.lineEnd()), n = d;
						else if (i && n && r ^ g) {
							var v;
						...
						}!g || n && yl(n, p) || t.point(p[0], p[1]), n = p, c = g, e = y
					},
					lineEnd: function() {
						c && t.lineEnd(), n = null
					},
					...
					x = {
						...
						polygonEnd: function() {
							var n = function() {
								...
								e = _ && n,
								i = (c = st(c)).length;
							(e || i) && (a.polygonStart(), e && (a.lineStart(), o(null, null, 1, a), a.lineEnd()), i && _l(c, u, n, o, a), a.polygonEnd());
							b = a, c = f = s = null
						}
					};
		...
		function Fl(t, n) {
			Nl = t *= xf, kl = Pf(n *= xf), Cl = Af(n), Dl.point = ql
		}
		...
		function ql(t, n) {
			...
			var e = Pf(n *= xf),
				...
				u = Cl * e - kl * r * o,
				c = kl * e + Cl * r * o;
			El.add(Tf($f(a * a + u * u), c)), Nl = t, kl = e, Cl = r
		}

		function Ul(t) {
			return El = new A, jf(t, Dl), +El
		}
		var Il = [null, null],
			Ol = {
				type: "LineString",
		...
		function Xl(t, n) {
			for (var e, r, i, o = 0, a = t.length; o < a; o++) {
				if (0 === (r = Bl(t[o], n))) return !0;
				if (o > 0 && (i = Bl(t[o], t[o - 1])) > 0 && e <= i && r <= i && (e + r - i) * (1 - Math.pow((e - r) / i, 2)) < gf * i) return !0;
				e = r
			}
			return !1
		}
		...
		function Ql() {
			...
			return v.lines = function() {
				...
				return arguments.length ? (y = +h, c = Zl(o, i, 90), f = Kl(n, t, y), s = Zl(u, a, 90), l = Kl(r, e, y), v) : y
			}, v.extentMajor([
				[-180, -90 + pf],
				[180, 90 - pf]
			]).extentMinor([
		...
		var Jl, th, nh, eh, rh = t => t,
			...
			ah = {
				...
				lineEnd: Uf,
				polygonStart: function() {
					ah.lineStart = uh, ah.lineEnd = sh
				},
				polygonEnd: function() {
					ah.lineStart = ah.lineEnd = ah.point = Uf, ih.add(wf(oh)), oh = new A
				},
				result: function() {
					var t = ih / 2;
					return ih = new A, t
		...
		function ch(t, n) {
			ah.point = fh, Jl = nh = t, th = eh = n
		}

		function fh(t, n) {
			oh.add(eh * t - nh * n), nh = t, eh = n
		}
		...
		var lh = ah,
			...
			yh = {
				...
				result: function() {
					...
					return ph = gh = -(dh = hh = 1 / 0), t
				}
			};
		var vh, _h, bh, mh, xh = yh,
			wh = 0,
			Mh = 0,
			Th = 0,
			Ah = 0,
			...
			Ph = {
				...
				lineEnd: Fh,
				polygonStart: function() {
					Ph.lineStart = qh, Ph.lineEnd = Uh
				},
				polygonEnd: function() {
					Ph.point = zh, Ph.lineStart = $h, Ph.lineEnd = Fh
				},
				result: function() {
					var t = Ch ? [Nh / Ch, kh / Ch] : Eh ? [Ah / Eh, Sh / Eh] : Th ? [wh / Th, Mh / Th] : [NaN, NaN];
					return wh = Mh = Th = Ah = Sh = Eh = Nh = kh = Ch = 0, t
				}
			};
		...
		function Rh(t, n) {
			var e = t - bh,
				r = n - mh,
				i = $f(e * e + r * r);
			Ah += i * (bh + t) / 2, Sh += i * (mh + n) / 2, Eh += i, zh(bh = t, mh = n)
		}
		...
		function Ih(t, n) {
			Ph.point = Oh, zh(vh = bh = t, _h = mh = n)
		}
		...
		function Oh(t, n) {
			var e = t - bh,
				r = n - mh,
				i = $f(e * e + r * r);
			Ah += i * (bh + t) / 2, Sh += i * (mh + n) / 2, Eh += i, Nh += (i = mh * t - bh * n) * (bh + t), kh += i * (mh + n), Ch += 3 * i, zh(bh = t, mh = n)
		}
		var Bh = Ph;
			...
			point: function(t, n) {
				switch (this._point) {
					...
					case 1:
						...
						break;
					default:
						this._context.moveTo(t + this._radius, n), this._context.arc(t, n, this._radius, 0, bf)
				}
			},
			result: Uf
		};
		var Lh, jh, Hh, Xh, Gh, Vh = new A,
			Wh = {
				point: Uf,
				lineStart: function() {
					Wh.point = Zh
		...
		function Zh(t, n) {
			Wh.point = Kh, jh = Xh = t, Hh = Gh = n
		}

		function Kh(t, n) {
			Xh -= t, Gh -= n, Vh.add($f(Xh * Xh + Gh * Gh)), Xh = t, Gh = n
		}
		var Qh = Wh;
		let Jh, td, nd, ed;
		class rd {
			...
			point(t, n) {
				switch (this._point) {
					...
					case 1:
						...
						break;
					default:
						if (this._append `M${t},${n}`, this._radius !== nd || this._append !== td) {
							const t = this._radius,
								n = this._;
							this._ = "", this._append `m0,${t}a${t},${t} 0 1,1 0,${-2*t}a${t},${t} 0 1,1 0,${2*t}z`, nd = t, td = this._append, ed = this._, this._ = n
						}
						this._ += ed
				}
			}
		...
		function ud(t, n, e) {
			...
			return t.scale(150).translate([0, 0]), null != r && t.clipExtent(null), jf(e, t.stream(xh)), n(xh.result()), null != r && t.clipExtent(r), t
		}
				...
				function e(r, i, o, a, u, c, f, s, l, h, d, p, g, y) {
					...
					if (b > 4 * n && g--) {
						var m = a + h,
							...
							C = N - i,
							P = _ * k - v * C;
						(P * P / b > n || wf((v * k + _ * C) / b - .5) > .3 || a * h + u * d + c * p < dd) && (e(r, i, o, a, u, c, E, N, A, m /= M, x /= M, w, g, y), y.point(E, N), e(E, N, A, m, x, w, f, s, l, h, d, p, g, y))
					}
				}
				return function(n) {
					...
					function _(r, i) {
						var o = gs([r, i]),
							a = t(r, i);
						e(s, l, f, h, d, p, s = a[0], l = a[1], f = r, h = o[0], d = o[1], p = o[2], hd, n), n.point(s, l)
					}
					...
					function w() {
						e(s, l, f, h, d, p, i, o, r, a, u, c, hd, n), g.lineEnd = b, b()
					}
					return g
				}
			}(t, n) : function(t) {
		...
		function _d(t) {
			...
			function k() {
				...
				return e = cl(y, v, _), u = al(n, r), c = al(e, u), a = pd(u, S), C()
			}
			...
			return E.stream = function(t) {
					...
					return arguments.length ? (M = +t ? Sl(w = t * xf) : (w = null, Al), C()) : w * mf
				}, E.clipExtent = function(t) {
					return arguments.length ? (A = null == t ? (T = r = i = o = null, rh) : $l(T = +t[0][0], r = +t[0][1], i = +t[1][0], o = +t[1][1]), C()) : null == T ? null : [
						[T, r],
						[i, o]
					]
				}, E.scale = function(t) {
					...
					return arguments.length ? (p = t[0] % 360 * xf, g = t[1] % 360 * xf, k()) : [p * mf, g * mf]
				}, E.rotate = function(t) {
					return arguments.length ? (y = t[0] % 360 * xf, v = t[1] % 360 * xf, _ = t.length > 2 ? t[2] % 360 * xf : 0, k()) : [y * mf, v * mf, _ * mf]
				}, E.angle = function(t) {
					return arguments.length ? (b = t % 360 * xf, k()) : b * mf
				}, E.reflectX = function(t) {
					return arguments.length ? (m = t ? -1 : 1, k()) : m < 0
				}, E.reflectY = function(t) {
					return arguments.length ? (x = t ? -1 : 1, k()) : x < 0
				}, E.precision = function(t) {
					return arguments.length ? (a = pd(u, S = t * t), C()) : $f(S)
		...
		function md(t, n) {
			...
			return a.invert = function(t, n) {
				var e = o - n,
					a = Tf(t, wf(e)) * zf(e);
				return e * r < 0 && (a -= yf * zf(t) * zf(e)), [a / r, Ff((i - (t * t + e * e) * r * r) / (2 * r))]
			}, a
		}
		...
		function Cd(t, n) {
			...
			return o.invert = function(t, n) {
				var e = i - n,
					o = zf(r) * $f(t * t + e * e),
					a = Tf(t, wf(e)) * zf(e);
				return e * r < 0 && (a -= yf * zf(t) * zf(e)), [a / r, 2 * Mf(Cf(i / o, 1 / r)) - vf]
			}, o
		}
		...
		function zd(t, n) {
			...
			return o.invert = function(t, n) {
				var e = i - n,
					o = Tf(t, wf(e)) * zf(e);
				return e * r < 0 && (o -= yf * zf(t) * zf(e)), [o / r, i - zf(r) * $f(t * t + e * e)]
			}, o
		}
		...
		function Vd(t, n) {
			t instanceof Map ? (t = [void 0, t], void 0 === n && (n = Zd)) : void 0 === n && (n = Wd);
			for (var e, r, i, o, a, u = new Jd(t), c = [u]; e = c.pop();)
				if ((i = n(e.data)) && (a = (i = Array.from(i)).length))
					for (e.children = i, o = a - 1; o >= 0; --o) c.push(r = i[o] = new Jd(i[o])), r.parent = e, r.depth = e.depth + 1;
		...
		Ud.invert = function(t, n) {
			for (var e, r = n, i = r * r, o = i * i * i, a = 0; a < 12 && (o = (i = (r -= e = (r * ($d + Dd * i + o * (Rd + Fd * i)) - n) / ($d + 3 * Dd * i + o * (7 * Rd + 9 * Fd * i))) * r) * i * i, !(wf(e) < gf)); ++a);
			return [qd * t * ($d + 3 * Dd * i + o * (7 * Rd + 9 * Fd * i)) / Af(r), Ff(Pf(r) / qd)]
		}, Id.invert = Td(Mf), Od.invert = function(t, n) {
			var e, r = n,
				i = 25;
			do {
				var o = r * r,
		...
		}, Bd.invert = Td(Ff), Yd.invert = Td((function(t) {
			return 2 * Mf(t)
		...
		function cp(t, n) {
			for (var e, r, i = 0, o = (t = function(t, n) {
					...
					return t
				}(Array.from(t), n)).length, a = []; i < o;) e = t[i], r && lp(r, e) ? ++i : (r = dp(a = fp(a, e)), i = 0);
			return r
		}
		...
		function fp(t, n) {
			...
			for (e = 0; e < t.length; ++e)
				if (sp(n, t[e]) && hp(pp(t[e], n), t)) return [t[e], n];
			for (e = 0; e < t.length - 1; ++e)
				for (r = e + 1; r < t.length; ++r)
					if (sp(pp(t[e], t[r]), n) && sp(pp(t[e], n), t[r]) && sp(pp(t[r], n), t[e]) && hp(gp(t[e], t[r], n), t)) return [t[e], t[r], n];
			throw new Error
		}
		...
		function mp(t, n) {
			...
			yp(r, e, i = t[2]), e = new bp(e), r = new bp(r), i = new bp(i), e.next = i.previous = r, r.next = e.previous = i, i.next = r.previous = e;
			t: for (c = 3; c < o; ++c) {
				yp(e._, r._, i = t[c]), i = new bp(i), f = r.next, s = e.previous, l = r._.r, h = e._.r;
				do {
					if (l <= h) {
						if (vp(f._, i._)) {
				...
				for (i.previous = e, i.next = r, e.next = r.previous = r = i, a = _p(e);
					(i = i.next) !== r;)(u = _p(i)) < a && (e = i, a = u);
				r = e.next
			}
			for (e = [r._], i = r;
				(i = i.next) !== r;) e.push(i._);
			for (i = cp(e, n), c = 0; c < o; ++c)(e = t[c]).x -= i.x, e.y -= i.y;
			return i.r
		}
		...
		function Yp(t, n, e, r, i, o) {
			for (var a, u, c, f, s, l, h, d, p, g, y, v = [], _ = n.children, b = 0, m = 0, x = _.length, w = n.value; b < x;) {
				...
				}), a.dice ? Sp(a, e, r, i, w ? r += f * s / w : o) : Op(a, e, r, w ? e += c * s / w : i, o), w -= s, b = m
			}
			return v
		}
		var Lp = function t(n) {
			...
			function e(t, e, r, i, o) {
				if ((a = t._squarify) && a.ratio === n)
					for (var a, u, c, f, s, l = -1, h = a.length, d = t.value; ++l < h;) {
						...
						u.dice ? Sp(u, e, r, i, d ? r += (o - r) * u.value / d : o) : Op(u, e, r, d ? e += (i - e) * u.value / d : i, o), d -= u.value
					} else t._squarify = a = Yp(n, t, e, r, i, o), a.ratio = n
			}
			return e.ratio = function(n) {
				return t((n = +n) > 1 ? n : 1)
			}, e
		...
		function Gp(t) {
			...
			let r, i = 2;
			for (r = 2; r < n; ++r) {
				for (; i > 1 && Hp(t[e[i - 2]], t[e[i - 1]], t[r]) <= 0;) --i;
				e[i++] = r
			}
			return e.slice(0, i)
		}
		...
		function yg() {
			...
			}, dg.apply(i, arguments), i
		}

		function vg() {
			var t, n, e = yg().unknown(void 0),
				r = e.domain,
				i = e.range,
				o = 0,
				a = 1,
		...
		function Mg(t, n, e) {
			var r = t[0],
				...
				o = n[0],
				a = n[1];
			return i < r ? (r = wg(i, r), o = e(a, o)) : (r = wg(r, i), o = e(o, a)),
				function(t) {
					return o(r(t))
				}
		}
		...
		function Tg(t, n, e) {
			var r = Math.min(t.length, n.length) - 1,
				...
				o = new Array(r),
				a = -1;
			for (t[r] < t[0] && (t = t.slice().reverse(), n = n.slice().reverse()); ++a < r;) i[a] = wg(t[a], t[a + 1]), o[a] = e(n[a], n[a + 1]);
			return function(n) {
				var e = l(t, n, 1, r) - 1;
				return o[e](i[e](n))
			}
		...
		function Sg() {
			...
			function s() {
				...
				}(a[0], a[t - 1])), r = t > 2 ? Tg : Mg, i = o = null, l
			}
			...
			return l.invert = function(e) {
					...
					return arguments.length ? (a = Array.from(t, bg), s()) : a.slice()
				}, l.range = function(t) {
					return arguments.length ? (u = Array.from(t), s()) : u.slice()
				}, l.rangeRound = function(t) {
					return u = Array.from(t), c = Wr, s()
				}, l.clamp = function(t) {
					return arguments.length ? (f = !!t || xg, s()) : f !== xg
		...
		function Ng(n, e, r, i) {
			...
			switch ((i = tf(null == i ? ",f" : i)).type) {
				case "s":
					...
					return null != i.precision || isNaN(o = hf(a, u)) || (i.precision = o), t.formatPrefix(i, u);
				case "":
				case "e":
				case "g":
				case "p":
		...
		function qg(n) {
			...
			function u() {
				...
				}(a), r()[0] < 0 ? (i = Fg(i), o = Fg(o), n($g, Dg)) : n(Pg, zg), e
			}
			return e.base = function(t) {
				...
				if (null == n && (n = 10), null == r && (r = 10 === a ? "s" : ","), "function" != typeof r && (a % 1 || null != (r = tf(r)).precision || (r.trim = !0), r = t.format(r)), n === 1 / 0) return r;
			...
			return i.floor = n => (t(n = new Date(+n)), n), i.ceil = e => (t(e = new Date(e - 1)), n(e, 1), t(e), e), i.round = t => {
				...
				if (t >= t)
					if (r < 0)
						...
						for (; --r >= 0;)
							for (; n(t, 1), !e(t););
			})), e && (i.count = (n, r) => (Gg.setTime(+n), Vg.setTime(+r), t(Gg), t(Vg), Math.floor(e(Gg, Vg))), i.every = t => (t = Math.floor(t), isFinite(t) && t > 0 ? t > 1 ? i.filter(r ? n => r(n) % t == 0 : n => i.count(0, n) % t == 0) : i : null)), i
		}
		const Zg = Wg((() => {}), ((t, n) => {
			t.setTime(+t + n)
		}), ((t, n) => n - t));
		...
		function ov(t, n, e, i, o, a) {
			...
			function c(n, e, i) {
				const o = Math.abs(e - n) / i,
					a = r((([, , t]) => t)).right(u, o);
				if (a === u.length) return t.every(Z(n / iy, e / iy, i));
				if (0 === a) return Zg.every(Math.max(Z(n, e, i), 1));
		...
		const [av, uv] = ov(rv, Jy, qy, by, dy, fy), [cv, fv] = ov(nv, Ky, wy, gy, ly, uy);
			...
			function w(t, n) {
				return function(e) {
					var r, i, o, a = [],
						...
						c = 0,
						f = t.length;
					for (e instanceof Date || (e = new Date(+e)); ++u < f;) 37 === t.charCodeAt(u) && (a.push(t.slice(c, u)), null != (i = gv[r = t.charAt(++u)]) ? r = t.charAt(++u) : i = "e" === r ? " " : "0", (o = n[r]) && (r = o(e, i)), a.push(r), c = u + 1);
			...
			function M(t, n) {
				return function(e) {
					...
					if (n && !("Z" in o) && (o.Z = 0), "p" in o && (o.H = o.H % 12 + 12 * o.p), void 0 === o.m && (o.m = "q" in o ? o.q : 0), "V" in o) {
						...
						"w" in o || (o.w = 1), "Z" in o ? (i = (r = lv(hv(o.y, 0, 1))).getUTCDay(), r = i > 4 || 0 === i ? Uy.ceil(r) : Uy(r), r = vy.offset(r, 7 * (o.V - 1)), o.y = r.getUTCFullYear(), o.m = r.getUTCMonth(), o.d = r.getUTCDate() + (o.w + 6) % 7) : (i = (r = sv(hv(o.y, 0, 1))).getDay(), r = i > 4 || 0 === i ? My.ceil(r) : My(r), r = gy.offset(r, 7 * (o.V - 1)), o.y = r.getFullYear(), o.m = r.getMonth(), o.d = r.getDate() + (o.w + 6) % 7)
					} else("W" in o || "U" in o) && ("w" in o || (o.w = "u" in o ? o.u % 7 : "W" in o ? 1 : 0), i = "Z" in o ? lv(hv(o.y, 0, 1)).getUTCDay() : sv(hv(o.y, 0, 1)).getDay(), o.m = 0, o.d = "W" in o ? (o.w + 6) % 7 + 7 * o.W - (i + 5) % 7 : o.w + 7 * o.U - (i + 6) % 7);
					return "Z" in o ? (o.H += o.Z / 100 | 0, o.M += o.Z % 100, lv(o)) : sv(o)
				}
			}
			...
			function T(t, n, e, r) {
				for (var i, o, a = 0, u = n.length, c = e.length; a < u;) {
					...
					if (37 === (i = n.charCodeAt(a++))) {
						if (i = n.charAt(a++), !(o = x[i in gv ? n.charAt(a++) : i]) || (r = o(t, e, r)) < 0) return -1
		...
		function n_(t, n) {
			return t = t_(t), bv(Sy.count(nv(t), t) + (4 === nv(t).getDay()), n, 2)
		}
		...
		function c_(t) {
			...
			return (n > 0 ? "-" : (n *= -1, "+")) + bv(n / 60 | 0, "0", 2) + bv(n % 60, "0", 2)
		}
		...
		function x_(t, n) {
			return t = m_(t), bv(By.count(rv(t), t) + (4 === rv(t).getUTCDay()), n, 2)
		}
		...
		function z_(n) {
			return pv = dv(n), t.timeFormat = pv.format, t.timeParse = pv.parse, t.utcFormat = pv.utcFormat, t.utcParse = pv.utcParse, pv
		}
		t.timeFormat = void 0, t.timeParse = void 0, t.utcFormat = void 0, t.utcParse = void 0, z_({
			dateTime: "%x, %X",
			date: "%-m/%-d/%Y",
			time: "%-I:%M:%S %p",
			periods: ["AM", "PM"],
		...
		function O_(t, n, e, r, i, o, a, u, c, f) {
			...
			return s.invert = function(t) {
				...
				var e = h();
				return t && "function" == typeof t.range || (t = n(e[0], e[e.length - 1], null == t ? 10 : t)), t ? h(Cg(e, t)) : s
			}, s.copy = function() {
		...
		function B_() {
			...
			return f.domain = function(i) {
				...
				}, f.range = s(Vr), f.rangeRound = s(Wr), f.unknown = function(t) {
		...
		function j_() {
			...
			function p(t) {
				return function(n) {
					var e, r, i;
					return arguments.length ? ([e, r, i] = n, l = pi(t, [e, r, i]), d) : [l(0), l(.5), l(1)]
				}
			}
			return d.domain = function(a) {
				...
				}, d.range = p(Vr), d.rangeRound = p(Wr), d.unknown = function(t) {
		...
		Tw.prototype = ww.prototype, t.Adder = A, t.Delaunay = ju, t.FormatSpecifier = nf, t.InternMap = InternMap, t.InternSet = InternSet, t.Node = Jd, t.Path = Ia, t.Voronoi = Uu, t.ZoomTransform = ww, t.active = function(t, n) {
			var e, r, i = t.__transition;
			if (i)
				for (r in n = null == n ? null : n + "", i)
					if ((e = i[r]).state > Ui && e.name === n) return new go([
						[t]
					], Ko, n, +r);
			return null
		}, t.arc = function() {
			...
			for (var n in t) {
				...
				if (i)
					...
					vc && r[4] && !r[7] && (i = i.replace(/-/g, "/").replace(/T/, " ")), i = new Date(i)
				} else i = e;
				else i = null;
				t[n] = i
			}
		...
		}, t.color = $e, t.contourDensity = function() {
			var t = su,
				n = lu,
				e = hu,
				r = 960,
			...
			function d(t) {
				var n = l(t),
					e = s(n),
					r = Math.pow(2, 2 * a);
				return Array.isArray(e) || (e = V(Number.MIN_VALUE, tt(n) / r, e)), ou().size([c, f]).thresholds(e.map((t => t * r)))(n).map(((t, n) => (t.value = +e[n], p(t))))
			}
			...
			return d.contours = function(t) {
				...
				return arguments.length ? (t = "function" == typeof n ? n : Ja(+n), d) : t
			}, d.y = function(t) {
				return arguments.length ? (n = "function" == typeof t ? t : Ja(+t), d) : n
			}, d.weight = function(t) {
				return arguments.length ? (e = "function" == typeof t ? t : Ja(+t), d) : e
			}, d.size = function(t) {
				...
				return arguments.length ? (s = "function" == typeof t ? t : Array.isArray(t) ? Ja(Ka.call(t)) : Ja(t), d) : s
		...
		}, t.contours = ou, t.count = _, t.create = function(t) {
			return Kn(Lt(t).call(document.documentElement))
		}, t.creator = Lt, t.cross = function(...t) {
		...
		}, t.csv = Mc, t.csvFormat = ic, t.csvFormatBody = oc, t.csvFormatRow = uc, t.csvFormatRows = ac, t.csvFormatValue = cc, t.csvParse = ec, t.csvParseRows = rc, t.cubehelix = Ar, t.cumsum = function(t, n) {
			var e = 0,
				r = 0;
			...
			function d(a, u) {
				if (!r && i.call(this, a, u)) {
					...
					c && (Kn(a.view).on("mousemove.drag", p, ie).on("mouseup.drag", g, ie), ue(a.view), oe(a), e = !1, t = a.clientX, n = a.clientY, c("start", a))
				}
			}
			...
			function g(t) {
				Kn(t.view).on("mousemove.drag mouseup.drag", null), ce(t.view, e), ae(t), c.mouse("end", t)
			}
			...
			function y(t, n) {
				if (i.call(this, t, n)) {
					var e, r, a = t.changedTouches,
						u = o.call(this, t, n),
						c = a.length;
					for (e = 0; e < c; ++e)(r = b(this, u, t, n, a[e].identifier, a[e])) && (oe(t), r("start", t, a[e]))
				}
			}
			...
			function v(t) {
				var n, e, r = t.changedTouches,
					i = r.length;
				for (n = 0; n < i; ++n)(e = c[r[n].identifier]) && (ae(t), e("drag", t, r[n]))
			}
			...
			function _(t) {
				...
				for (r && clearTimeout(r), r = setTimeout((function() {
						r = null
					}), 500), n = 0; n < o; ++n)(e = c[i[n].identifier]) && (oe(t), e("end", t, i[n]))
			}
			...
			return h.filter = function(t) {
				return arguments.length ? (i = "function" == typeof t ? t : fe(!!t), h) : i
			}, h.container = function(t) {
				return arguments.length ? (o = "function" == typeof t ? t : fe(t), h) : o
			}, h.subject = function(t) {
				return arguments.length ? (a = "function" == typeof t ? t : fe(t), h) : a
			}, h.touchable = function(t) {
				return arguments.length ? (u = "function" == typeof t ? t : fe(!!t), h) : u
			}, h.on = function() {
		...
		}, t.dragDisable = ue, t.dragEnable = ce, t.dsv = function(t, n, e, r) {
			3 === arguments.length && "function" == typeof e && (r = e, e = void 0);
			var i = tc(t);
			return xc(n, e).then((function(t) {
				return i.parse(t, r)
			}))
		}, t.dsvFormat = tc, t.easeBack = jo, t.easeBackIn = Yo, t.easeBackInOut = jo, t.easeBackOut = Lo, t.easeBounce = Oo, t.easeBounceIn = function(t) {
			return 1 - Oo(1 - t)
		}, t.easeBounceInOut = function(t) {
			return ((t *= 2) <= 1 ? 1 - Oo(1 - t) : Oo(t - 1) + 1) / 2
		}, t.easeBounceOut = Oo, t.easeCircle = ko, t.easeCircleIn = function(t) {
			return 1 - Math.sqrt(1 - t * t)
		}, t.easeCircleInOut = ko, t.easeCircleOut = function(t) {
			return Math.sqrt(1 - --t * t)
		}, t.easeCubic = mo, t.easeCubicIn = function(t) {
			return t * t * t
		}, t.easeCubicInOut = mo, t.easeCubicOut = function(t) {
			return --t * t * t + 1
		}, t.easeElastic = Go, t.easeElasticIn = Xo, t.easeElasticInOut = Vo, t.easeElasticOut = Go, t.easeExp = No, t.easeExpIn = function(t) {
			return Eo(1 - +t)
		}, t.easeExpInOut = No, t.easeExpOut = function(t) {
			return 1 - Eo(t)
		}, t.easeLinear = t => +t, t.easePoly = Mo, t.easePolyIn = xo, t.easePolyInOut = Mo, t.easePolyOut = wo, t.easeQuad = bo, t.easeQuadIn = function(t) {
			return t * t
		}, t.easeQuadInOut = bo, t.easeQuadOut = function(t) {
			return t * (2 - t)
		}, t.easeSin = So, t.easeSinIn = function(t) {
			return 1 == +t ? 1 : 1 - Math.cos(t * Ao)
		}, t.easeSinInOut = So, t.easeSinOut = function(t) {
			...
			function a() {
				for (var t, a, c, f, s, l, h, d = n.length, p = 0; p < o; ++p)
					for (a = Dc(n, Oc, Bc).visitAfter(u), t = 0; t < d; ++t) c = n[t], l = e[c.index], h = l * l, f = c.x + c.vx, s = c.y + c.vy, a.visit(g);
				...
				function g(t, n, e, o, a) {
					...
					if (u.index > c.index) {
						var g = f - u.x - u.vx,
							y = s - u.y - u.vy,
							v = g * g + y * y;
						v < p * p && (0 === g && (v += (g = Ic(r)) * g), 0 === y && (v += (y = Ic(r)) * y), v = (p - (v = Math.sqrt(v))) / v * i, c.vx += (g *= v) * (p = (d *= d) / (h + d)), c.vy += (y *= v) * p, u.vx -= g * (p = 1 - p), u.vy -= y * p)
					}
				}
			}
			...
			function l(r) {
				for (var i = 0, u = t.length; i < s; ++i)
					for (var c, f, l, h, d, p, g, y = 0; y < u; ++y) f = (c = t[y]).source, h = (l = c.target).x + l.vx - f.x - f.vx || Ic(a), d = l.y + l.vy - f.y - f.vy || Ic(a), h *= p = ((p = Math.sqrt(h * h + d * d)) - e[y]) / p * r * n[y], d *= p, l.vx -= h * (g = o[y]), l.vy -= d * g, f.vx += h * (g = 1 - g), f.vy += d * g
			}
			...
			function h() {
				if (r) {
					...
					for (a = 0, i = new Array(f); a < s; ++a)(c = t[a]).index = a, "object" != typeof c.source && (c.source = Lc(l, c.source)), "object" != typeof c.target && (c.target = Lc(l, c.target)), i[c.source.index] = (i[c.source.index] || 0) + 1, i[c.target.index] = (i[c.target.index] || 0) + 1;
			...
			function h(t, o, f, s) {
				...
				var l = t.x - n.x,
					...
					d = s - o,
					p = l * l + h * h;
				if (d * d / c < p) return p < u && (0 === l && (p += (l = Ic(e)) * l), 0 === h && (p += (h = Ic(e)) * h), p < a && (p = Math.sqrt(a * p)), n.vx += l * t.value * r / p, n.vy += h * t.value * r / p), !0;
				if (!(t.length || p >= u)) {
					(t.data !== n || t.next) && (0 === l && (p += (l = Ic(e)) * l), 0 === h && (p += (h = Ic(e)) * h), p < a && (p = Math.sqrt(a * p)));
					do {
		...
		}, t.formatDefaultLocale = sf, t.formatLocale = ff, t.formatSpecifier = tf, t.fsum = function(t, n) {
			const e = new A;
			if (void 0 === n)
			...
			return +e
		}, t.geoAlbers = wd, t.geoAlbersUsa = function() {
			var t, n, e, r, i, o, a = wd(),
				u = xd().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]),
				c = xd().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]),
				f = {
					point: function(t, n) {
						o = [t, n]
					}
			...
			return s.invert = function(t) {
				...
				return e = a.translate(t).clipExtent([
					...
					[o - .425 * n + pf, s + .12 * n + pf],
					[o - .214 * n - pf, s + .234 * n - pf]
				]).stream(f), i = c.translate([o - .205 * n, s + .212 * n]).clipExtent([
					[o - .214 * n + pf, s + .166 * n + pf],
					[o - .115 * n - pf, s + .234 * n - pf]
				]).stream(f), l()
			...
			return cs = new A, jf(t, fs), 2 * cs
		}, t.geoAzimuthalEqualArea = function() {
			return vd(Ad).scale(124.75).clipAngle(179.999)
		}, t.geoAzimuthalEqualAreaRaw = Ad, t.geoAzimuthalEquidistant = function() {
			return vd(Sd).scale(79.4188).clipAngle(179.999)
		}, t.geoAzimuthalEquidistantRaw = Sd, t.geoBounds = function(t) {
			var n, e, r, i, o, a, u;
			if (Jf = Qf = -(Zf = Kf = 1 / 0), os = [], jf(t, qs), e = os.length) {
				for (os.sort(Xs), n = 1, o = [r = os[0]]; n < e; ++n) Gs(r, (i = os[n])[0]) || Gs(r, i[1]) ? (Hs(r[0], i[1]) > Hs(r[0], r[1]) && (r[1] = i[1]), Hs(i[0], r[1]) > Hs(r[0], r[1]) && (r[0] = i[0])) : o.push(r = i);
				for (a = -1 / 0, n = 0, r = o[e = o.length - 1]; n <= e; r = i, ++n) i = o[n], (u = Hs(r[1], i[0])) > a && (a = u, Zf = i[0], Qf = r[1])
			}
			return os = as = null, Zf === 1 / 0 || Kf === 1 / 0 ? [
				[NaN, NaN],
				[NaN, NaN]
			] : [
				[Zf, Kf],
			...
			xs = ws = Ms = Ts = As = Ss = Es = Ns = 0, ks = new A, Cs = new A, Ps = new A, jf(t, Vs);
			var n = +ks,
				e = +Cs,
				r = +Ps,
				i = Nf(n, e, r);
			return i < gf && (n = Ss, e = Es, r = Ns, ws < pf && (n = Ms, e = Ts, r = As), (i = Nf(n, e, r)) < gf) ? [NaN, NaN] : [Tf(e, n) * mf, Ff(r / i) * mf]
			...
			function a() {
				...
				return t = [], n = cl(-a[0] * xf, -a[1] * xf, 0).invert, dl(o, u, c, 1), a = {
					type: "Polygon",
					coordinates: [t]
				}, t = n = null, a
			}
			return a.center = function(t) {
				return arguments.length ? (e = "function" == typeof t ? t : ol([+t[0], +t[1]]), a) : e
			}, a.radius = function(t) {
				return arguments.length ? (r = "function" == typeof t ? t : ol(+t), a) : r
			}, a.precision = function(t) {
				return arguments.length ? (i = "function" == typeof t ? t : ol(+t), a) : i
			}, a
		}, t.geoClipAntimeridian = Al, t.geoClipCircle = Sl, t.geoClipExtent = function() {
			var t, n, e, r = 0,
				i = 0,
				o = 960,
				a = 500;
		...
		}, t.geoClipRectangle = $l, t.geoConicConformal = function() {
			return bd(Cd).scale(109.5).parallels([30, 30])
		}, t.geoConicConformalRaw = Cd, t.geoConicEqualArea = xd, t.geoConicEqualAreaRaw = md, t.geoConicEquidistant = function() {
			return bd(zd).scale(131.154).center([0, 13.9389])
		}, t.geoConicEquidistantRaw = zd, t.geoContains = function(t, n) {
			return (t && Yl.hasOwnProperty(t.type) ? Yl[t.type] : jl)(t, n)
		}, t.geoDistance = Bl, t.geoEqualEarth = function() {
			return vd(Ud).scale(177.158)
		}, t.geoEqualEarthRaw = Ud, t.geoEquirectangular = function() {
			return vd(Pd).scale(152.63)
		}, t.geoEquirectangularRaw = Pd, t.geoGnomonic = function() {
			return vd(Id).scale(144.049).clipAngle(60)
		}, t.geoGnomonicRaw = Id, t.geoGraticule = Ql, t.geoGraticule10 = function() {
			return Ql()()
			...
			return b.invert = function(e) {
				...
				return arguments.length ? (v = null == t ? (d = e = r = i = null, rh) : $l(d = +t[0][0], e = +t[0][1], r = +t[1][0], i = +t[1][1]), _()) : null == d ? null : [
					[d, e],
					[r, i]
				]
			}, b.scale = function(t) {
				...
				return arguments.length ? (n = Pf(h = e % 360 * xf), t = Af(h), _()) : h * mf
		...
		}, t.geoLength = Ul, t.geoMercator = function() {
			return Nd(Ed).scale(961 / bf)
		}, t.geoMercatorRaw = Ed, t.geoNaturalEarth1 = function() {
			return vd(Od).scale(175.295)
		}, t.geoNaturalEarth1Raw = Od, t.geoOrthographic = function() {
			return vd(Bd).scale(249.5).clipAngle(90 + pf)
		}, t.geoOrthographicRaw = Bd, t.geoPath = function(t, n) {
			let e, r, i = 3,
				o = 4.5;

			function a(t) {
				return t && ("function" == typeof o && r.pointRadius(+o.apply(this, arguments)), jf(t, e(r))), r.result()
			}
			return a.area = function(t) {
				return jf(t, e(lh)), lh.result()
			}, a.measure = function(t) {
				return jf(t, e(Qh)), Qh.result()
			}, a.bounds = function(t) {
				return jf(t, e(xh)), xh.result()
			}, a.centroid = function(t) {
				return jf(t, e(Bh)), Bh.result()
			}, a.projection = function(n) {
				return arguments.length ? (e = null == n ? (t = null, rh) : (t = n).stream, a) : t
			}, a.context = function(t) {
				return arguments.length ? (r = null == t ? (n = null, new rd(i)) : new Yh(n = t), "function" != typeof o && r.pointRadius(o), a) : n
				...
				return null === n && (r = new rd(i)), a
			}, a.projection(t).digits(i).context(n)
		}, t.geoProjection = vd, t.geoProjectionMutator = _d, t.geoRotation = hl, t.geoStereographic = function() {
			return vd(Yd).scale(250).clipAngle(142)
		}, t.geoStereographicRaw = Yd, t.geoStream = jf, t.geoTransform = function(t) {
			return {
				stream: od(t)
			}
		...
		}, t.geoTransverseMercatorRaw = Ld, t.gray = function(t, n) {
		...
		}, t.groups = z, t.hcl = pr, t.hierarchy = Vd, t.histogram = J, t.hsl = Xe, t.html = Nc, t.image = function(t, n) {
		...
		}, t.interpolate = Vr, t.interpolateArray = function(t, n) {
			return (Or(n) ? Ir : Br)(t, n)
		}, t.interpolateBasis = Nr, t.interpolateBasisClosed = kr, t.interpolateBlues = Gb, t.interpolateBrBG = ob, t.interpolateBuGn = Mb, t.interpolateBuPu = Ab, t.interpolateCividis = function(t) {
		...
		}, t.interpolateCool = am, t.interpolateCubehelix = hi, t.interpolateCubehelixDefault = im, t.interpolateCubehelixLong = di, t.interpolateDate = Yr, t.interpolateDiscrete = function(t) {
			var n = t.length;
			return function(e) {
				return t[Math.max(0, Math.min(n - 1, Math.floor(e * n)))]
			}
		}, t.interpolateGnBu = Eb, t.interpolateGreens = Wb, t.interpolateGreys = Kb, t.interpolateHcl = fi, t.interpolateHclLong = si, t.interpolateHsl = ai, t.interpolateHslLong = ui, t.interpolateHue = function(t, n) {
			var e = zr(+t, +n);
			return function(t) {
				var n = e(t);
		...
		}, t.interpolateRdBu = db, t.interpolateRdGy = gb, t.interpolateRdPu = qb, t.interpolateRdYlBu = vb, t.interpolateRdYlGn = bb, t.interpolateReds = nm, t.interpolateRgb = Rr, t.interpolateRgbBasis = qr, t.interpolateRgbBasisClosed = Ur, t.interpolateRound = Wr, t.interpolateSinebow = function(t) {
			var n;
			return t = (.5 - t) * Math.PI, cm.r = 255 * (n = Math.sin(t)) * n, cm.g = 255 * (n = Math.sin(t + fm)) * n, cm.b = 255 * (n = Math.sin(t + sm)) * n, cm + ""
		}, t.interpolateSpectral = xb, t.interpolateString = Gr, t.interpolateTransformCss = ni, t.interpolateTransformSvg = ei, t.interpolateTurbo = function(t) {
		...
		}, t.interpolateViridis = hm, t.interpolateWarm = om, t.interpolateYlGn = Bb, t.interpolateYlGnBu = Ib, t.interpolateYlOrBr = Lb, t.interpolateYlOrRd = Hb, t.interpolateZoom = ii, t.interrupt = Vi, t.intersection = function(t, ...n) {
			...
			return null == n ? (r.restart(t, n, e), r) : (r._restart = r.restart, r.restart = function(t, n, e) {
				n = +n, e = null == e ? Si() : +e, r._restart((function o(a) {
					a += i, r._restart(o, i += n, e), t(a)
				}), n, e)
			}, r.restart(t, n, e), r)
		}, t.isoFormat = R_, t.isoParse = q_, t.json = function(t, n) {
			return fetch(t, n).then(Ac)
		}, t.lab = ur, t.lch = function(t, n, e, r) {
			...
			if (1 === e.length) {
				...
				for (const n of t)(i ? e(n, r) < 0 : 0 === e(n, n)) && (r = n, i = !0);
			return r
		}, t.leastIndex = dt, t.line = Ym, t.lineRadial = Zm, t.link = ax, t.linkHorizontal = function() {
			return ax(nx)
			...
			return r
		}, t.namespace = Ot, t.namespaces = It, t.nice = K, t.now = Si, t.pack = function() {
			var t = null,
				n = 1,
				e = 1,
				r = ep;
			...
			function i(i) {
				const o = up();
				return i.x = n / 2, i.y = e / 2, t ? i.eachBefore(wp(t)).eachAfter(Mp(r, .5, o)).eachBefore(Tp(1)) : i.eachBefore(wp(xp)).eachAfter(Mp(ep, 1, o)).eachAfter(Mp(r, i.r / Math.min(n, e), o)).eachBefore(Tp(Math.min(n, e) / (2 * i.r))), i
			}
			return i.radius = function(n) {
				return arguments.length ? (t = tp(n), i) : t
			}, i.size = function(t) {
				return arguments.length ? (n = +t[0], e = +t[1], i) : [n, e]
			}, i.padding = function(t) {
				return arguments.length ? (r = "function" == typeof t ? t : rp(+t), i) : r
			}, i
		...
		}, t.path = Oa, t.pathRound = function(t = 3) {
			return new Ia(+t)
		...
		}, t.piecewise = pi, t.pointRadial = Qm, t.pointer = ee, t.pointers = function(t, n) {
			return t.target && (t = ne(t), void 0 === n && (n = t.currentTarget), t = t.touches || [t]), Array.from(t, (t => ee(t, n)))
			...
			for (r.sort(Xp), n = 0; n < e; ++n) i[n] = [r[n][0], -r[n][1]];
			var o = Gp(r),
				a = Gp(i),
				u = a[0] === o[0],
			...
			return c
		}, t.precisionFixed = lf, t.precisionPrefix = hf, t.precisionRound = df, t.quadtree = Dc, t.quantile = ut, t.quantileIndex = ft, t.quantileSorted = ct, t.quantize = function(t, n) {
			for (var e = new Array(n), r = 0; r < n; ++r) e[r] = t(r / (n - 1));
			return e
		}, t.quickselect = it, t.radialArea = Km, t.radialLine = Zm, t.randomBates = tg, t.randomBernoulli = rg, t.randomBeta = ag, t.randomBinomial = ug, t.randomCauchy = fg, t.randomExponential = ng, t.randomGamma = og, t.randomGeometric = ig, t.randomInt = Zp, t.randomIrwinHall = Jp, t.randomLcg = function(t = Math.random()) {
			let n = 0 | (0 <= t && t < 1 ? t / hg : Math.abs(t));
			return () => (n = 1664525 * n + 1013904223 | 0, hg * (n >>> 0))
		}, t.randomLogNormal = Qp, t.randomLogistic = sg, t.randomNormal = Kp, t.randomPareto = eg, t.randomPoisson = lg, t.randomUniform = Wp, t.randomWeibull = cg, t.range = ht, t.rank = function(t, e = n) {
			if ("function" != typeof t[Symbol.iterator]) throw new TypeError("values is not iterable");
			let r = Array.from(t);
			...
			let a, u;
			return (t = Uint32Array.from(r, ((t, n) => n))).sort(e === n ? (t, n) => B(r[t], r[n]) : O(o)), t.forEach(((t, n) => {
		...
		}, t.rgb = qe, t.ribbon = function() {
			return Za()
		}, t.ribbonArrow = function() {
			return Za(Wa)
		}, t.rollup = D, t.rollups = R, t.scaleBand = vg, t.scaleDiverging = function t() {
			var n = kg(j_()(xg));
		...
		}, t.scaleDivergingPow = H_, t.scaleDivergingSqrt = function() {
			...
			return r.invert = r, r.domain = r.range = function(t) {
				return arguments.length ? (n = Array.from(t, bg), r) : n.slice()
			}, r.unknown = function(t) {
				return arguments.length ? (e = t, r) : e
			}, r.copy = function() {
				return t(n).unknown(e)
			}, n = arguments.length ? Array.from(n, bg) : [0, 1], kg(r)
		}, t.scaleImplicit = gg, t.scaleLinear = function t() {
			var n = Eg();
			return n.copy = function() {
				return Ag(n, t())
			}, dg.apply(n, arguments), kg(n)
		}, t.scaleLog = function t() {
			const n = qg(Sg()).domain([1, 10]);
			return n.copy = () => Ag(n, t()).base(n.base()), dg.apply(n, arguments), n
		}, t.scaleOrdinal = yg, t.scalePoint = function() {
			return _g(vg.apply(null, arguments).paddingInner(1))
		}, t.scalePow = Hg, t.scaleQuantile = function t() {
			var e, r = [],
				i = [],
				o = [];
			...
			return o.invert = function(t) {
				...
				return arguments.length ? (e.range((r = Array.from(t, bg)).map(Xg)), o) : r.slice()
		...
		}, t.scaleSequentialPow = L_, t.scaleSequentialQuantile = function t() {
			var e = [],
				r = xg;
			...
			function r(r) {
				...
				if (null != t) {
					const n = h.map(((n, e) => function(t) {
						...
						e = n.map(zp),
						i = new Set(n).add("");
					for (const t of e) i.has(t) || (i.add(t), n.push(t), e.push(zp(t)), h.push(kp));
					d = (t, e) => n[e], p = (t, n) => e[n]
				}
				for (a = 0, i = h.length; a < i; ++a) o = h[a], f = h[a] = new Jd(o), null != (s = d(o, a, r)) && (s += "") && (l = f.id = s, g.set(l, g.has(l) ? Np : f)), null != (s = p(o, a, r)) && (s += "") && (f.parent = s);
				for (a = 0; a < i; ++a)
					if (s = (f = h[a]).parent) {
						if (!(c = g.get(s))) throw new Error("missing: " + s);
						if (c === Np) throw new Error("ambiguous: " + s);
				...
				if (null != t) {
					for (; u.data === kp && 1 === u.children.length;) u = u.children[0], --i;
					for (let t = h.length - 1; t >= 0 && (f = h[t]).data === kp; --t) f.data = null
				}
				if (u.parent = Ep, u.eachBefore((function(t) {
						t.depth = t.parent.depth + 1, --i
					})).eachBefore(Qd), u.parent = null, i > 0) throw new Error("cycle");
				return u
			}
			return r.id = function(t) {
				return arguments.length ? (n = tp(t), r) : n
			}, r.parentId = function(t) {
				return arguments.length ? (e = tp(t), r) : e
			}, r.path = function(n) {
				return arguments.length ? (t = tp(n), r) : t
			}, r
		}, t.style = bn, t.subset = function(t, n) {
			return bt(n, t)
		}, t.sum = function(t, n) {
			let e = 0;
			if (void 0 === n)
			...
			return e
		}, t.superset = bt, t.svg = kc, t.symbol = function(t, n) {
			let e = null,
				r = km(i);
		...
		}, t.symbolAsterisk = cx, t.symbolCircle = fx, t.symbolCross = sx, t.symbolDiamond = dx, t.symbolDiamond2 = px, t.symbolPlus = gx, t.symbolSquare = yx, t.symbolSquare2 = vx, t.symbolStar = xx, t.symbolTimes = Px, t.symbolTriangle = Mx, t.symbolTriangle2 = Ax, t.symbolWye = Cx, t.symbolX = Px, t.symbols = zx, t.symbolsFill = zx, t.symbolsStroke = $x, t.text = xc, t.thresholdFreedmanDiaconis = function(t, n, e) {
			const r = _(t),
				i = ut(t, .75) - ut(t, .25);
		...
		}, t.thresholdSturges = Q, t.tickFormat = Ng, t.tickIncrement = W, t.tickStep = Z, t.ticks = V, t.timeDay = gy, t.timeDays = yy, t.timeFormatDefaultLocale = z_, t.timeFormatLocale = dv, t.timeFriday = Ey, t.timeFridays = Dy, t.timeHour = ly, t.timeHours = hy, t.timeInterval = Wg, t.timeMillisecond = Zg, t.timeMilliseconds = Kg, t.timeMinute = uy, t.timeMinutes = cy, t.timeMonday = My, t.timeMondays = Cy, t.timeMonth = Ky, t.timeMonths = Qy, t.timeSaturday = Ny, t.timeSaturdays = Ry, t.timeSecond = oy, t.timeSeconds = ay, t.timeSunday = wy, t.timeSundays = ky, t.timeThursday = Sy, t.timeThursdays = $y, t.timeTickInterval = fv, t.timeTicks = cv, t.timeTuesday = Ty, t.timeTuesdays = Py, t.timeWednesday = Ay, t.timeWednesdays = zy, t.timeWeek = wy, t.timeWeeks = ky, t.timeYear = nv, t.timeYears = ev, t.timeout = Di, t.timer = ki, t.timerFlush = Ci, t.transition = yo, t.transpose = yt, t.tree = function() {
			var t = Dp,
				n = 1,
				e = 1,
				r = null;
			...
			function o(n) {
				...
				n.parent.A = function(n, e, r) {
					if (e) {
						for (var i, o = n, a = n, u = e, c = o.parent.children[0], f = o.m, s = a.m, l = u.m, h = c.m; u = Fp(u), o = Rp(o), u && o;) c = Rp(c), (a = Fp(a)).a = n, (i = u.z + l - o.z - f + t(u._, o._)) > 0 && (qp(Up(u, n, r), n, i), f += i, s += i), l += u.m, f += o.m, h += c.m, s += a.m;
						u && !Fp(a) && (a.t = u, a.m += l - s), o && !Rp(c) && (c.t = o, c.m += f - h, r = n)
					}
					return r
				}(n, i, n.parent.A || r[0])
			}
			...
			function s(t) {
				return t.x0 = t.y0 = 0, t.x1 = e, t.y1 = r, t.eachBefore(l), i = [0], n && t.eachBefore(Ap), t
			}
			...
			return s.round = function(t) {
				...
				return arguments.length ? (a = "function" == typeof t ? t : rp(+t), s) : a
			}, s.paddingRight = function(t) {
				return arguments.length ? (u = "function" == typeof t ? t : rp(+t), s) : u
			}, s.paddingBottom = function(t) {
				return arguments.length ? (c = "function" == typeof t ? t : rp(+t), s) : c
			}, s.paddingLeft = function(t) {
				return arguments.length ? (f = "function" == typeof t ? t : rp(+t), s) : f
			}, s
			...
			function T(t, ...n) {
				if (r.apply(this, arguments)) {
					...
					if (e.wheel) e.mouse[0][0] === s[0] && e.mouse[0][1] === s[1] || (e.mouse[1] = i.invert(e.mouse[0] = s)), clearTimeout(e.wheel);
						...
						if (i.k === u) return;
						e.mouse = [s, i.invert(s)], Vi(this), e.start()
					}
				...
				if (!e && r.apply(this, arguments)) {
					var i = t.currentTarget,
						...
						u = Kn(t.view).on("mousemove.zoom", (function(t) {
							...
							u.on("mousemove.zoom mouseup.zoom", null), ce(t.view, a.moved), Sw(t), a.event(t).end()
						}), !0),
						c = ee(t, i),
						s = t.clientX,
						l = t.clientY;
					ue(t.view), Aw(t), a.mouse = [c, this.__zoom.invert(c)], Vi(this), a.start()
				}
			}
			...
			function S(t, ...n) {
				if (r.apply(this, arguments)) {
					...
					Sw(t), s > 0 ? Kn(this).transition().duration(s).call(x, l, a, t) : Kn(this).call(v.transform, l, a, t)
				}
			}
			...
			function E(e, ...i) {
				if (r.apply(this, arguments)) {
					...
					for (Aw(e), a = 0; a < s; ++a) c = [c = ee(u = f[a], this), this.__zoom.invert(c), u.identifier], l.touch0 ? l.touch1 || l.touch0[2] === c[2] || (l.touch1 = c, l.taps = 0) : (l.touch0 = c, o = !0, l.taps = 1 + !!t);
			...
			function N(t, ...n) {
				if (this.__zooming) {
					var e, r, i, a, u = w(this, n).event(t),
						c = t.changedTouches,
						s = c.length;
					for (Sw(t), e = 0; e < s; ++e) i = ee(r = c[e], this), u.touch0 && u.touch0[2] === r.identifier ? u.touch0[0] = i : u.touch1 && u.touch1[2] === r.identifier && (u.touch1[0] = i);
			...
			function k(t, ...r) {
				if (this.__zooming) {
					...
					else if (a.end(), 2 === a.taps && (o = ee(o, this), Math.hypot(n[0] - o[0], n[1] - o[1]) < y)) {
